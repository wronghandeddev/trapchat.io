    ...
    <div className="outterContainer2">
      <div className="container2">
			...
			<ul>
				...
				<li className="list1">
				Understand that any browser you use while using this app could have trackers because of logins to 3rd party sites(google, facebook, linkin, and so on). We reccommend that to stay absolutly anno
				</li>
			</ul>
			<p>
