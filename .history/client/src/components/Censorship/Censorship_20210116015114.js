...
return (
    <div className="outterContainer2">
      <div className="container2">
			...
			<ul>
				<li className="">When Ever Possible Meet in a person to discuss the room name(which should be random but memorable), and the usernames that your going to go by.(never write these things down use only your memory for gaurenteed security)</li>
				<li>
